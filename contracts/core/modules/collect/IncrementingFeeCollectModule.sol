...
contract IncrementingFeeCollectModule is FeeModuleBase, FollowValidationModuleBase, ICollectModule {
    ...
    function initializePublicationCollectModule(
        ...
        _dataByPublicationByProfile[profileId][pubId].increaseAmount = increaseAmount;
    ...
    function _processCollect(
        ...
        _dataByPublicationByProfile[profileId][pubId].amount += _dataByPublicationByProfile[profileId][pubId].increaseAmount;
